package org.netty.demo.io.nio.chat;
...
public class NIOChatServer {
    ...
    private void readTble(SelectionKey key) throws IOException {
...
//                System.out.println("从IP地址为：" + sc.getRemoteAddress() + "的获取到消息: " + content);
    ...
    private void acceptTable(SelectionKey key) throws IOException {
